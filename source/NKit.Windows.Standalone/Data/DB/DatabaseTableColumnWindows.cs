namespace NKit.Data.DB
{
    ...
    [Serializable]
    public abstract class DatabaseTableColumnWindows
    {
        #region Constructors
		
        public DatabaseTableColumnWindows()
        {
        }
        ...
        public DatabaseTableColumnWindows(DataRow schemaRow)
        {
        ...
        public bool IsNullable
        {
            get
            {
                ...
                throw new Exception(string.Format(
                    ...
                    _isNullable,
                    EntityReaderGeneric<DatabaseTableColumnWindows>.GetPropertyName(p => p.IsNullable, false),
