namespace NKit.Data.DB.SQLServer
{
    ...
    /// </summary>
    [Serializable]
    public class SqlDatabaseTableColumnWindows : DatabaseTableColumnWindows
    {
        #region Constructors

        public SqlDatabaseTableColumnWindows()
        {
        }

        public SqlDatabaseTableColumnWindows(DataRow schemaRow) : base(schemaRow)
        {
        }
        ...
        public override void PopulateFromSchema(DataRow schemaRow)
        {
            ...
            _sqlDbType = SqlTypeConverterWindows.Instance.GetSqlDbType(_dataType);
        }
