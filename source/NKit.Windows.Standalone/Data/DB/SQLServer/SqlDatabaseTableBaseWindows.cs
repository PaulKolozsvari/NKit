namespace NKit.Data.DB.SQLServer
{
    ...
    [Serializable]
    public class SqlDatabaseTableBaseWindows : DatabaseTableWindows
    {
        #region Constructors

        public SqlDatabaseTableBaseWindows() : base()
        {
        }

        public SqlDatabaseTableBaseWindows(string tableName, string connectionString) 
            : base(tableName, connectionString)
        {
        }

        public SqlDatabaseTableBaseWindows(DataRow schemaRow)
            : base(schemaRow)
        {
        }

        public SqlDatabaseTableBaseWindows(DataRow schemaRow, string connectionString) 
