namespace NKit.Winforms
{
    ...
    public partial class CustomToolStripWindows : ToolStrip
    {
        #region Constructors

        public CustomToolStripWindows()
        {
            InitializeComponent();
        ...
        public CustomToolStripWindows(CustomProfessionalColorsWindows colors)
        {
            _colors = colors;
            this.Renderer = new ToolStripProfessionalRenderer(_colors);
        }
