namespace NKit.Utilities.Cab
{
    ...
    /// </summary>
    public class CabInfoWindows : IEnumerable<CabResourceInfoWindows>
    {
        #region Constructors
            ...
            Nullable<double> versionMax)
        {
            ...
            _cabResources = new Dictionary<string, CabResourceInfoWindows>();
        }
        ...
        private Dictionary<string, CabResourceInfoWindows> _cabResources;
        ...
        /// <returns></returns>
        public CabResourceInfoWindows this[string fileName]
        {
            get
            {
        ...
        /// <returns></returns>
        public bool ContainsCabResource(CabResourceInfoWindows resource)
        {
        ...
        /// </summary>
        /// <param name="resource"></param>
        public CabResourceInfoWindows AddCabResource(string filePath)
        {
            CabResourceInfoWindows resource = new CabResourceInfoWindows(filePath, _cabResources.Count + 1, true);
        ...
        /// </summary>
        /// <param name="resource"></param>
        public void RemoveCabResource(CabResourceInfoWindows resource)
        {
            if (!ContainsCabResource(resource))
            {
                throw new ArgumentException(string.Format(
        ...
        {
            int i = 1;
            foreach (CabResourceInfoWindows resource in (from r in this
        ...
        {
            foreach (CabResourceInfoWindows resource in this)
            {
                FileSystemHelper.ValidateFileExists(resource.AbsoluteFilePath);
            }
        }

        public IEnumerator<CabResourceInfoWindows> GetEnumerator()
        {
