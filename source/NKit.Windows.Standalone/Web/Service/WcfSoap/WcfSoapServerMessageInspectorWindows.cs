namespace NKit.Web.Service.WcfSoap
{
    ...
    public class WcfSoapServerMessageInspectorWindows : IDispatchMessageInspector
    {
        #region Constructors

        public WcfSoapServerMessageInspectorWindows(bool traceSoapMessages, bool traceSoapMessageHeaders)
        {
