namespace NKit.Web.Client.SOAP
{
    ...
    public class SoapClientMessageInspectorWindows : IClientMessageInspector
    {
        #region Constructors

        public SoapClientMessageInspectorWindows(bool traceSoapMessages, bool traceSoapMessageHeaders)
        {
