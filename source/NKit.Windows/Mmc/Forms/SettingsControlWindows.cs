namespace NKit.Mmc.Forms
{
    ...
    public partial class SettingsControlWindows : UserControl, IFormViewControl
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public SettingsControlWindows()
        {
            InitializeComponent();
        ...
        private SettingsFormViewWindows _settingsFormView = null; //The form to which this control is associated with.
