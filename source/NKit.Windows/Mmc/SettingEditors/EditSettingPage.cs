namespace NKit.Mmc.SettingEditors
{
    ...
    public class EditSettingPage : PropertyPage
    {
        ...
        public EditSettingPage(object selectionObject)
        {
            ...
            {
                _childSettingControl = new EditEnumSettingControlWindows(this);
            }
            else if (selectedSetting.SettingType.Equals(typeof(Boolean)))
            {
                _childSettingControl = new EditBoolSettingControlWindows(this);
            }
            else if (selectedSetting.SettingType.Equals(typeof(Int64)))
            {
                _childSettingControl = new EditLongSettingControlWindows(this);
            }
            else
            {
        ...
        private IEditSettingWindows _childSettingControl;
