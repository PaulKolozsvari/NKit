namespace NKit.Mmc.SettingEditors
{
    ...
    public partial class EditLongSettingControlWindows : UserControl, IEditSettingWindows
    {
        public EditLongSettingControlWindows(EditSettingPage parentPropertyPage)
        {
            InitializeComponent();
        ...
        public void RefreshData(object selectionObject)
        {
            ...
            if (!_selectedSettingItem.SettingType.Equals(typeof(Int64)))
            {
            ...
            txtValue.Value = Convert.ToInt64(_selectedSettingItem.SettingValue);
            txtValue.Focus();
