namespace NKit.Mmc.SettingEditors
{
    ...
    public partial class EditEnumSettingControlWindows : UserControl, IEditSettingWindows
    {
        #region Constructors

        public EditEnumSettingControlWindows(EditSettingPage parentPropertyPage)
        {
            InitializeComponent();
        ...
        public void RefreshData(object selectionObject)
        {
            ...
            Array enumValues = EnumHelperWindows.GetEnumValues(_selectedSettingItem.SettingType);
