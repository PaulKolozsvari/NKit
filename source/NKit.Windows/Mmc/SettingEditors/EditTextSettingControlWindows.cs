namespace NKit.Mmc.SettingEditors
{
    ...
    public partial class EditTextSettingControlWindows : UserControl, IEditSettingWindows
    {
        public EditTextSettingControlWindows(EditSettingPage parentPropertyPage)
        {
            InitializeComponent();
