namespace NKit.Mmc.SettingEditors
{
    ...
    public partial class EditBoolSettingControlWindows : UserControl, IEditSettingWindows
    {
        public EditBoolSettingControlWindows(EditSettingPage parentPropertyPage)
        {
            InitializeComponent();
