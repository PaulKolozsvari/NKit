namespace NKit.Data.ORM
{
    ...
    /// </summary>
    public class OrmAssemblyWindows
    {
        #region Constructors

        public OrmAssemblyWindows(string assemblyName, AssemblyBuilderAccess assemblyBuilderAccess)
        {
            Initialize(assemblyName, null, assemblyBuilderAccess);
        }

        public OrmAssemblyWindows(string assemblyName, string assemblyFileName, AssemblyBuilderAccess assemblyBuilderAccess)
        {
