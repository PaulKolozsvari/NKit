namespace NKit.Data.ORM
{
    ...
    public class OrmAssembly
    {
        ...
        protected EntityCacheGeneric<string, OrmTypeWindows> _ormTypes;
        ...
        public EntityCacheGeneric<string, OrmTypeWindows> OrmTypes
        {
            ...
            AssemblyBuilderAccess assemblyBuilderAccess)
        {
            ...
            if (string.IsNullOrEmpty(assemblyName))
            {
                throw new NullReferenceException(string.Format(
                    ...
                    EntityReaderGeneric<OrmAssembly>.GetPropertyName(p => p.AssemblyName, false),
        ...
        {
            return Path.Combine(InformationWindows.GetExecutingDirectory(), _assemblyFileName);
        }
        ...
        private void SaveOrmAssemblyToExecutingDirectory()
        {
            ...
            if (Environment.CurrentDirectory == InformationWindows.GetExecutingDirectory())
            {
        ...
        public void Save(string ormAssemblyOutputDirectory)
        {
            ...
            if (string.IsNullOrEmpty(ormAssemblyOutputDirectory) || (ormAssemblyOutputDirectory.ToLower().Trim() == InformationWindows.GetExecutingDirectory().ToLower().Trim()))
            {
