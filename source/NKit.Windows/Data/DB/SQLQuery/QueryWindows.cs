namespace NKit.Data.DB.SQLQuery
{
    ...
    public abstract class QueryWindows
    {
        #region Constructors
        ...
        public QueryWindows()
        {
            ...
            _whereClause = new List<WhereClauseColumnWindows>();
        }

        public QueryWindows(SqlQueryKeyword keyword)
        {
            _sqlQueryString = new StringBuilder();
            _sqlParameters = new List<DbParameter>();
            _tableNamesInQuery = new List<string>();
        ...
        public QueryWindows(string sqlQueryString)
        {
        ...
        protected List<WhereClauseColumnWindows> _whereClause;
        ...
        public List<WhereClauseColumnWindows> WhereClause
        {
        ...
        public abstract void AppendWhereColumns(List<WhereClauseColumnWindows> whereClause);

        public abstract void AppendWhereColumns(List<WhereClauseColumnWindows> whereClause, bool appendWhereStatement);
