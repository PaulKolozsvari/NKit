namespace NKit.Data.DB.SQLQuery
{
    ...
    public class SqlQueryWindows
    {
        #region Constructors

        public SqlQueryWindows()
        {
        ...
        public SqlQueryWindows(SqlQueryKeyword keyword)
        {
            _sqlQueryString = new StringBuilder();
            _sqlParameters = new List<SqlParameter>();
            _tableNamesInQuery = new List<string>();
        ...
        public SqlQueryWindows(string sqlQueryString)
        {
        ...
        public void AppendWhereColumns(List<WhereClauseColumn> whereClause)
        {
            ...
            foreach (WhereClauseColumn whereColumn in whereClause)
            {
                ...
                {
                    string parameterName = string.Format("@{0}", DataShaperWindows.GetUniqueIdentifier());
