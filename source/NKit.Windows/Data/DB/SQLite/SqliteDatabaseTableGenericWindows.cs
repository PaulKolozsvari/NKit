namespace NKit.Data.DB.SQLite
{
    ...
    [Serializable]
	public class SqliteDatabaseTableGenericWindows<E> : SqliteDatabaseTableWindows where E : class
    {
        #region Constructors

        public SqliteDatabaseTableGenericWindows() : base()
        {
        }

        public SqliteDatabaseTableGenericWindows(string tableName, string connectionString)
            : base(tableName, connectionString)
        {
        }

        public SqliteDatabaseTableGenericWindows(DataRow schemaRow, string connectionString)
