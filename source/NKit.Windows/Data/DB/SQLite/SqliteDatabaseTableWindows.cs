namespace NKit.Data.DB.SQLite
{
    ...
    public class SqliteDatabaseTableWindows : DatabaseTableWindows
    {
        ...
        public SqliteDatabaseTableWindows() : base()
        {
        }

        public SqliteDatabaseTableWindows(string tableName, string connectionString)
            : base(tableName, connectionString)
        {
        }

        public SqliteDatabaseTableWindows(DataRow schemaRow)
            : base(schemaRow)
        {
        }

        public SqliteDatabaseTableWindows(DataRow schemaRow, string connectionString)
        ...
        public override string GetSqlCreateTableScript()
        {
            ...
            foreach (SqliteDatabaseTableColumnWindows column in _columns)
            {
