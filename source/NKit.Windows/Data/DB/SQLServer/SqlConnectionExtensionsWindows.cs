namespace NKit.Data.DB
{
    ...
    public static class SqlConnectionExtensionsWindows
    {
        #region Constants
        ...
        /// <returns></returns>
        public static EntityCacheGeneric<string, ForeignKeyInfoWindows> GetTableForeignKeys(this SqlConnection connection, string tableName)
        {
