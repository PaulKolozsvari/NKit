namespace NKit.Data.DB.LINQ
{
    ...
    public class LinqFunnelContextWindows : IDisposable
    {
        ...
        public LinqFunnelContextWindows(DataContext db, LinqFunnelSettingsWindows settings)
        {
            DB = db;
        ...
        private LinqFunnelSettingsWindows _linqFunnelSettings;

        #endregion //Fields

        #region Properties

        public LinqFunnelSettingsWindows LinqFunnelSettings
        {
        ...
        public virtual List<LinqFunnelChangeResultWindows> Save<E>(E entity, bool saveChildren) where E : class
        {
        ...
        /// <param name="entity">The the entity to save.</param>
        /// <returns>Returns a list of change results i.e. what entities where updated</returns>
        public virtual List<LinqFunnelChangeResultWindows> Save(Type entityType, object entity, bool saveChildren)
        {
            ...
            List<LinqFunnelChangeResultWindows> result = null;
            if (original == null)
            {
                DB.GetTable(entityType).InsertOnSubmit(entity);
                result = new List<LinqFunnelChangeResultWindows>();
                result.Add(new LinqFunnelChangeResultWindows()
                {
                    Function = "INSERT",
        ...
        public virtual List<LinqFunnelChangeResultWindows> Insert<E>(E entity, bool saveChildren) where E : class
        {
            return Insert(typeof(E), entity, saveChildren);
        }

        public virtual List<LinqFunnelChangeResultWindows> Insert(Type entityType, object entity, bool saveChildren)
        {
            PropertyInfo surrogateKey = GetEntitySurrogateKey(entityType);
            bool containsIdentityColumn = IsIdentityColumn(surrogateKey);
            object surrogateKeyValue = surrogateKey.GetValue(entity, null);
            ...
            DB.GetTable(entityType).InsertOnSubmit(entity);
            List<LinqFunnelChangeResultWindows> result = new List<LinqFunnelChangeResultWindows>();
            result.Add(new LinqFunnelChangeResultWindows()
            {
                Function = "INSERT",
                DateChanged = DateTime.Now,
        ...
        private List<LinqFunnelChangeResultWindows> UpdateOriginalEntity<E>(E original, E latest, bool saveChildren) where E : class
        {
        ...
        /// <param name="latest">The latest entity received from the client.</param>
        /// <returns>Returns a list of change results containing all the fields that were changed and their original and new values.</returns>
        private List<LinqFunnelChangeResultWindows> UpdateOriginalEntity(Type entityType, object original, object latest, bool saveChildren)
        {
        ...
        public virtual List<LinqFunnelChangeResultWindows> Delete<E>(E entity) where E : class
        {
        ...
        /// <param name="entity">The entity to be deleted.</param>
        /// <returns>Returns a list of change results.</returns>
        public virtual List<LinqFunnelChangeResultWindows> Delete(object entity)
        {
        ...
        /// <returns>Returns a list of change results.</returns>
        public virtual List<LinqFunnelChangeResultWindows> Delete<E, T>(E entity, bool createTombstone)
            where E : class
            where T : class
        {
        ...
        /// <param name="createTombstone">Indicates whether a tombstone should be created.</param>
        /// <returns>Returns a list of change results.</returns>
        public virtual List<LinqFunnelChangeResultWindows> Delete(object entity, bool createTombstone, Type tombstoneType)
        {
        ...
        /// <returns>Returns a list of change results.</returns>
        public virtual List<LinqFunnelChangeResultWindows> DeleteBySurrogateKey<E>(object surrogateKeyValue) where E : class
        {
        ...
        /// <param name="surrogatekeyValue">The entity to be deleted.</param>
        /// <returns>Returns a list of change results.</returns>
        public virtual List<LinqFunnelChangeResultWindows> DeleteBySurrogateKey(object surrogateKeyValue, Type entityType)
        {
        ...
        /// <param name="createTombstone">Indicates whether a tombstone should be created.</param>
        /// <returns>Returns a list of change results.</returns>
        public virtual List<LinqFunnelChangeResultWindows> DeleteBySurrogateKey<E, T>(object surrogateKeyValue, bool createTombstone)
            where E : class
            where T : class
        {
        ...
        /// <param name="createTombstone">Indicates whether a tombstone should be created.</param>
        /// <returns>Returns a list of change results.</returns>
        public virtual List<LinqFunnelChangeResultWindows> DeleteBySurrogateKey(
        ...
        public virtual List<LinqFunnelChangeResultWindows> DeleteAll<E>() where E : class
        {
        ...
        /// </summary>
        /// <typeparam name="E">The entity type i.e. of the table whose records (entities) will be deleted.</typeparam>
        public virtual List<LinqFunnelChangeResultWindows> DeleteAll(Type entityType)
        {
            ITable table = DB.GetTable(entityType);
