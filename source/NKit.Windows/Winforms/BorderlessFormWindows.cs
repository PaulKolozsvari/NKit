namespace NKit.Winforms
{
    ...
    public partial class BorderlessFormWindows : Form
    {
        //Articles used:
        ...
        public BorderlessFormWindows(bool animate)
        {
            InitializeComponent();
            _originalFormTitle = FormTitle;
            this.DoubleBuffered = true;
        ...
        private void _timerTextAnimator_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
        {
            ...
            lock (_titleAnimatorLock)
            {
                ...
                if (_updateFormTitle == null || this.Disposing || this.IsDisposed)
                {
                    return;
                }
