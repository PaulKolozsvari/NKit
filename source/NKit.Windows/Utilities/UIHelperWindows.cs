namespace NKit.Utilities
{
    ...
    public class UIHelperWindows
    {
        ...
        public static Dictionary<string, Type> GetTypeNameToControlTypeMappings()
        {
            ...
            result.Add(typeof(Int64).FullName, typeof(NumericTextBoxWindows));
            result.Add(typeof(UInt16).FullName, typeof(NumericUpDown));
            result.Add(typeof(UInt32).FullName, typeof(NumericUpDown));
            result.Add(typeof(UInt64).FullName, typeof(NumericTextBoxWindows));
            result.Add(typeof(Single).FullName, typeof(NumericTextBoxWindows));
            result.Add(typeof(Double).FullName, typeof(NumericTextBoxWindows));
            result.Add(typeof(Decimal).FullName, typeof(NumericTextBoxWindows));
