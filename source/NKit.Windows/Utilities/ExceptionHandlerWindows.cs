namespace NKit.Utilities
{
    ...
    public class ExceptionHandlerWindows : ExceptionHandler
    {
        ...
        {
            return HandleException(exception, form: null, keyEventHandler: null, eventDetailsMessage: null, true, out emailErrorMessage, out emailLogMessageText, emailNotificationRecipients, showMessageBoxOnException: null);
        }
        ...
        public static bool HandleException(
            ...
            List<EmailNotificationRecipient> emailNotificationRecipients)
        {
            return HandleException(exception, form: null, keyEventHandler: null, null, emailException, out emailErrorMessage, out emailLogMessageText, emailNotificationRecipients, showMessageBoxOnException: null);
        }
        ...
        public static bool HandleException(
            ...
            List<EmailNotificationRecipient> emailNotificationRecipients)
        {
            return HandleException(exception, form: null, keyEventHandler: null, eventDetailsMessage, emailException: true, out emailErrorMessage, out emailLogMessageText, emailNotificationRecipients, showMessageBoxOnException: null);
        }
        ...
        public static bool HandleException(
            ...
            List<EmailNotificationRecipient> emailNotificationRecipients)
        {
            return HandleException(exception, form: null, keyEventHandler: null, eventDetailsMessage, emailException, out emailErrorMessage, out emailLogMessageText, emailNotificationRecipients, showMessageBoxOnException: null);
        }
        ...
        public static bool HandleException(
            ...
            List<EmailNotificationRecipient> emailNotificationRecipients)
        {
            return HandleException(exception, form, keyEventHandler, eventDetailsMessage, emailException: true, out emailErrorMessage, out emailLogMessageText, emailNotificationRecipients, showMessageBoxOnException: null);
        }
