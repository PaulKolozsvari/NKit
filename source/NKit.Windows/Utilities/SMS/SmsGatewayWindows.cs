namespace NKit.Utilities.SMS
{
    ...
    public class SmsGatewayWindows
    {
        #region Constructors

        public SmsGatewayWindows(
        ...
        /// </summary>
        public event OnSmsReceivedHandlerWindows OnSmsReceived;
        ...
        private void LogMessage(string message)
        {
            ...
            {
                GOCWindows.Instance.Logger.LogMessage(new LogMessage(message, LogMessageType.Information, LoggingLevel.Minimum));
            }
        }
        ...
        public static Nullable<DateTime> GetDateTimeFromSmsDateTime(string receivedDateTimeRaw, bool ignoreTimeZone)
        {
            ...
            {
                GOCWindows.Instance.Logger.LogMessage(new LogError(ex, LoggingLevel.Normal));
            }
            return result;
        }
        ...
        public void SendSms(SmsInfoWindows smsInfo)
        {
            ValidateSerialPortIsOpen();
