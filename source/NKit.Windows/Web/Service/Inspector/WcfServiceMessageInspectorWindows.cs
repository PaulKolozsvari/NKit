namespace NKit.Web.Service.Inspector
{
    ...
    public class WcfServiceMessageInspectorWindows : IDispatchMessageInspector
    {
        #region Constructors

        public WcfServiceMessageInspectorWindows(bool traceMessages, bool traceMessageHeaders)
        {
