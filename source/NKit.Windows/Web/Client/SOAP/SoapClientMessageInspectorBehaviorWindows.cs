namespace NKit.Web.Client.SOAP
{
    ...
    public class SoapClientMessageInspectorBehaviorWindows : IEndpointBehavior
    {
        #region Constructors

        public SoapClientMessageInspectorBehaviorWindows(bool traceSoapMessages, bool traceSoapMessageHeaders)
        {
