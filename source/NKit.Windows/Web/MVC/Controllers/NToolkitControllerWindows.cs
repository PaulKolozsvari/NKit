namespace NKit.Web.MVC.Controllers
{
    ...
    public class NKitControllerWindows : Controller
    {
        #region Constants
        ...
        protected virtual void LogHeaders()
        {
            ...
            GOCWindows.Instance.Logger.LogMessage(new LogMessage(allHeadersFullString, LogMessageType.Information, LoggingLevel.Maximum));
        }
