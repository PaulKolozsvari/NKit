namespace NKit.Data.DB.SQLite
{
    ...
    public class SqliteDatabaseTableColumnCore : DatabaseTableColumnCore
    {
        #region Constructors

        public SqliteDatabaseTableColumnCore()
        {
        }

        public SqliteDatabaseTableColumnCore(DataRow schemaRow) : base(schemaRow)
        {
        }
        ...
        public override void PopulateFromSchema(DataRow schemaRow)
        {
            ...
            _sqlDbType = SqliteTypeConverterCore.Instance.GetSqlDbType(_dataType);
