namespace NKit.Data.DB
{
    ...
    [Serializable]
    public abstract class DatabaseTableCore
    {
        #region Constructors

        public DatabaseTableCore()
        {
            _columns = new EntityCacheGeneric<string, DatabaseTableColumnCore>();
            _tableName = this.GetType().Name;
            _childrenTables = new EntityCacheGeneric<string, EntityCacheGeneric<string, ForeignKeyInfoCore>>();
        }

        public DatabaseTableCore(string tableName, string connectionString)
        {
            _columns = new EntityCacheGeneric<string, DatabaseTableColumnCore>();
        ...
        public DatabaseTableCore(DataRow schemaRow)
        {
            _columns = new EntityCacheGeneric<string, DatabaseTableColumnCore>();
        ...
        public DatabaseTableCore(DataRow schemaRow, string connectionString)
        {
            _columns = new EntityCacheGeneric<string, DatabaseTableColumnCore>();
            PopulateFromSchema(schemaRow);
            _connectionString = connectionString;
        ...
        protected EntityCacheGeneric<string, DatabaseTableColumnCore> _columns;
        protected Type _mappedType;
        protected string _mappedTypeName;
        protected string _connectionString;
        protected EntityCacheGeneric<string, EntityCacheGeneric<string, ForeignKeyInfoCore>> _childrenTables;
        ...
        public virtual EntityCacheGeneric<string, DatabaseTableColumnCore> Columns
        {
            get { return _columns; }
            set { _columns = value; }
        }
        ...
        /// </summary>
        public virtual EntityCacheGeneric<string, EntityCacheGeneric<string, ForeignKeyInfoCore>> ChildrenTables
        {
        ...
        public virtual EntityCacheGeneric<string, DatabaseTableColumnCore> GetForeignKeyColumns()
        {
            EntityCacheGeneric<string, DatabaseTableColumnCore> result = new EntityCacheGeneric<string, DatabaseTableColumnCore>();
