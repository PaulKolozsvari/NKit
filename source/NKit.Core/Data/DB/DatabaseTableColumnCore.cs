namespace NKit.Data.DB
{
    ...
    [Serializable]
    public abstract class DatabaseTableColumnCore
    {
        #region Constructors

        public DatabaseTableColumnCore()
        {
        }
        ...
        public DatabaseTableColumnCore(DataRow schemaRow)
        {
        ...
        public bool IsNullable
        {
            get
            {
                ...
                throw new Exception(string.Format(
                    ...
                    _isNullable,
                    EntityReaderGeneric<DatabaseTableColumnCore>.GetPropertyName(p => p.IsNullable, false),
