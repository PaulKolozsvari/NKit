namespace NKit.Data.DB.SQLQuery
{
    ...
    /// </summary>
    public class WhereClauseComparisonOperatorCore
    {
        #region Constructors

        public WhereClauseComparisonOperatorCore(string comparisonOperator)
        {
        ...
        public WhereClauseComparisonOperatorCore(ComparisonOperator comparisonOperator)
        {
