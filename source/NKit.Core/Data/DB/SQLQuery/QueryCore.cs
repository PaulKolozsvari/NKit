namespace NKit.Data.DB.SQLQuery
{
    ...
    public abstract class QueryCore
    {
        #region Constructors
        ...
        public QueryCore()
        {
            ...
            _whereClause = new List<WhereClauseColumnCore>();
        }

        public QueryCore(SqlQueryKeyword keyword)
        {
            _sqlQueryString = new StringBuilder();
            _sqlParameters = new List<DbParameter>();
            _tableNamesInQuery = new List<string>();
        ...
        public QueryCore(string sqlQueryString)
        {
        ...
        protected List<WhereClauseColumnCore> _whereClause;
        ...
        public List<WhereClauseColumnCore> WhereClause
        {
        ...
        public abstract void AppendWhereColumns(List<WhereClauseColumnCore> whereClause);

        public abstract void AppendWhereColumns(List<WhereClauseColumnCore> whereClause, bool appendWhereStatement);

        public abstract void AppendWhereClause(WhereClauseCore whereClause);
