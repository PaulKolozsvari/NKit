namespace NKit.Data
{
    ...
    public partial class EntityReaderGeneric<E> : EntityReader
    {
        #region Methods

        public static DataTable GetDataTable(bool shapeColumnNames)
        {
            return GetDataTable(shapeColumnNames, null);
        }

        public static DataTable GetDataTable(bool shapeColumnNames, List<string> topColumnNames)
        {
            return GetDataTable(shapeColumnNames, typeof(E), topColumnNames);
        }
