namespace NKit.Data.DB.SQLQuery
{
    ...
    public class WhereClauseComparisonOperator
    {
        ...
        public WhereClauseComparisonOperator(WhereClauseComparisonOperator comparisonOperator)
        {
        ...
        public static WhereClauseComparisonOperator GetComparisonOperatorFromString(string comparisonOperator)
        {
            ...
            foreach (KeyValuePair<string, string> keyPair in GetComparisonOperators())
            {
                ...
                {
                    return (WhereClauseComparisonOperator)Enum.Parse(typeof(WhereClauseComparisonOperator), keyPair.Key);
                }
            }
            throw new ArgumentException(string.Format("Could not find a {0} for string {1}.", typeof(WhereClauseComparisonOperator).Name, comparisonOperator));
        }
