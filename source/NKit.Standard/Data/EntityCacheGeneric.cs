namespace NKit.Data
{
    ...
    using NKit.Web.Client.DataProgress;
    using NKit.Web.Client.REST;
    using System.Diagnostics;

    #endregion //Using Directives

    public partial class EntityCacheGeneric<K, E> : IEnumerable<E> where E : class
    {
        #region Constructors
        ...
        public EntityCacheGeneric(string name, string defaultFilePath)
        {
            _name = name;
        ...
        public virtual Dictionary<K, E> DataTableToDictionary(DataTable table)
        {
            ...
            {
                E e = EntityReaderGeneric<E>.PopulateFromDataRow(Activator.CreateInstance<E>(), row);
        ...
        public virtual bool RefreshFromServer()
        {
            throw new NotImplementedException(string.Format(
                "{0} has no implementation for refesing from server.",
                this.GetType().Name));
        }
