namespace NKit.Data.ORM
{
    ...
    public partial class OrmType
    {
        ...
        protected void Initialize(string typeName, TypeBuilder typeBuilder)
        {
            ...
            if (string.IsNullOrEmpty(typeName))
            {
                throw new NullReferenceException(string.Format(
                    ...
                    EntityReaderGeneric<OrmType>.GetPropertyName(p => p.TypeName, false),
            ...
            if (typeBuilder == null)
            {
                throw new NullReferenceException(string.Format(
                    "{0} may not be null when constructing a {1}.",
                    EntityReaderGeneric<OrmType>.GetPropertyName(p => p.TypeBuilder, false),
                    this.GetType().FullName));
            }
            _typeName = typeName;
        ...
        {
            _dotNetType = _typeBuilder.CreateTypeInfo().AsType();
            return _dotNetType;
        }
