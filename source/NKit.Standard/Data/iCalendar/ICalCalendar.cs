namespace NKit.Data.iCalendar
{
    ...
    public partial class ICalCalendar
    {
        #region Constructors
            ...
            set 
            {
                if (string.IsNullOrEmpty(value))
                {
                    throw new ArgumentNullException(string.Format(
                        ...
                        EntityReaderGeneric<ICalCalendar>.GetPropertyName(p => p.CountryCode, false),
        ...
        public string CountryName
        {
            ...
            set 
            {
                if (string.IsNullOrEmpty(value))
                {
                    throw new ArgumentNullException(string.Format(
                        "{0} may not be null on a {1}.",
                        EntityReaderGeneric<ICalCalendar>.GetPropertyName(p => p.CountryName, false),
                        typeof(ICalCalendar).Name));
                }
                _countryName = value;
            }
