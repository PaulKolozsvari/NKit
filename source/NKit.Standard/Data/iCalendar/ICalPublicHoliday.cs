namespace NKit.Data.iCalendar
{
    ...
    public partial class ICalPublicHoliday
    {
            ...
            set 
            {
                if (string.IsNullOrEmpty(value))
                {
                    throw new ArgumentNullException(string.Format("{0} may not be null on a {1}.",
                        EntityReaderGeneric<ICalPublicHoliday>.GetPropertyName(p => p.EventName, false),
        ...
        public string DateIdentifier
        {
            ...
            set 
            {
                ...
                {
                    throw new ArgumentNullException(string.Format("{0} may not be null on a {1}.",
                        EntityReaderGeneric<ICalPublicHoliday>.GetPropertyName(p => p.DateIdentifier, false),
                        typeof(ICalPublicHoliday).Name));
                }
